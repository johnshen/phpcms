...
$LANG['news_list']					=	'公告列表';
$LANG['news_add']					=	'添加公告';
$LANG['news_title']					=	'公告标题：';
$LANG['endtime_lessthan_starttime'] =	'開始時間需要晚於結束時間';
$LANG['newsments_cannot_be_empty']	=	'公告内容不能为空';
$LANG['newsment_successful_added']	=	'公告添加成功';
$LANG['newsd_a']					=	'公告修改成功';
$LANG['news_passed']				=	'公告批量通过完成！';
$LANG['news_deleted']				=	'公告批量删除完成！';
$LANG['startdate']						=	'起始日期';
$LANG['enddate']						=	'截止日期';
$LANG['news_content']				=	'公告内容：';
$LANG['news_status']				=	'公告状态：';
$LANG['edit_news']					=	'编辑公告';
$LANG['inputer']						=	'录入者';
